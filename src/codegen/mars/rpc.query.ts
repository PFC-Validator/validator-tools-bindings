...
export const createRPCQueryClient = async ({
  ...
  return {
    ...
    mars: {
      incentives: {
        v1beta1: (await import("./incentives/v1beta1/query.rpc.Query")).createRpcQueryExtension(client)
      },
      safety: {
        v1beta1: (await import("./safety/v1beta1/query.rpc.Query")).createRpcQueryExtension(client)
      }
    }
  };
};